...
<body onload="maxdatefix()">
    ...
    <div class="container-fluid">
         <div class="shadow-lg bg-white row top ">
            <div class="col-12">
                <h5 class="lead">One last step left</h5>
...
<!-- bs -->
    <div class="container-fluid ">
        <form action="../php/setupprofile.php" method="POST" onsubmit="return submitForm()">
            <div class="row outer shadow-lg bg-white py-5">
                <div class="col-lg-6 col-md-12 form-group pl-5 border-right">
                    ...
                    <div class="usr-text d-flex">
                        ...
                        <div style="margin-left:-35px" >
                                <select required class="selectpicker sel sel1" name="phonecode" size="4" data-live-search="true" style="margin-left:-35px !important">
                                    ...
                                    <option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
                                     ...
                                     <div>
                                     <input required type="number" name="phonenum" id="phonenum" class="phh" placeholder="10-digit number" onblur="phonevalid();">
                    ...
                    <div class="lel ">
                        <div class="usr-text">
                            ...
                            <input type="date" class="inp inp-size" name="dob" id="datefield" min='1900-01-01' max="" value="" onblur="dobvalid();" required>
                        ...
                        <div class="usr-text" style="padding-left:20px;">
                            ...
                            <select id="gender" name="gender" required class="selectpicker sel">
                    ...
                    <div class="lel">
                        ...
                        <div class="usr-text" style="padding-left:20px;">
                            ...
                            <select name="usrt" id="usr-sel" required class="selectpicker sel" onchange="user()">
                ...
                <div class="col-lg-6 col-md-12 pr-5">
                    <div class="cont">
                            <div class="dev form-group" id="dev1" required>
                                <div class="lol">
                                    <div class="usr-text">
                                        <span class="span1">Education</span>
                                        <input type="text" placeholder="Highest Qualification" id="edud" name="edu" class="inp inp-size" onblur="eduvalid()">
                                    ...
                                    <div class="usr-text" style="padding-left:20px;">
                                        ...
                                        <select  id="proff" class="selectpicker sel" name="skills[]" size="4" multiple data-live-search="true" onchange="profvalid()">
                                ...
                                <div class="work-xp ">
                                    ...
                                    <input type="number" name="exp" step="1" min="1" max="80"  id="yr" style="border: .2px solid #542ebf; border-radius: 5px; padding:2px;" onblur="expvalid()">
                                    <span id="exp_err"><i class="fa fa-exclamation-triangle"  title="Please Fill" aria-hidden="true" style="color: red;"></i></span>
                                    <br><br>
                                    <div class="form-group purple-border">
                                        <label for="accom">Accomplishments</label><span id="accomp_err"><i class="fa fa-exclamation-triangle"  title="Please Fill" aria-hidden="true" style="color: red;"></i></span>
                                        <textarea  class="form-control" id="accom" name="accomp" rows="6"  maxlength="2000" minlength="20" onblur="accvalid()" ></textarea>
                            ...
                            <div class="cust usr-text form-group lol2" id="cust1">
                                ...
                                <select name="whoo" id="whooo" class="selectpicker" onchange="whovalid()">
                                    <option hidden disabled selected></option>
                                    <option value="Individual">Individual</option>
                                    <option value="Org">Organisation</option>
                                </select>
                                <span id="who_err"><i class="fa fa-exclamation-triangle "  title="Please Fill" aria-hidden="true" style="color: red;"></i></span>
                                <hr>
                            </div>
                            ...
                            <div>
                                <div class="form-group purple-border">
                                    ...
                                    <textarea required class="form-control" id="bio" name="biot" placeholder="Tell us more about yourself" rows="6" maxlength="2000" minlength="20"></textarea>
                                </div>
